...
from internal.repositories.db.models import Document, DocumentTags
...
class DocumentRepository(BaseRepository):
    def __init__(self):
        super().__init__()
        self.table = Document
        self.tags_table = DocumentTags

    def get_document(self, document_uuid: UUID):
    ...
    def add_document(self, document_uuid: UUID, document_type: str, name: str, number: str, release_date: datetime.date, start_date: datetime.date):
    ...
    async def delete_document_access(self, document_uuid: UUID):
